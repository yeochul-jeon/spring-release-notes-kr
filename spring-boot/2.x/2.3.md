...
### 4. Spring Cloud Connectors 완전 제거
...
### 1. Docker 이미지 빌드 (Cloud Native Buildpacks)
...
### 4. Kubernetes Liveness / Readiness 프로브
...
| `ON_TRACE_PARAM` (에러 페이지 스택트레이스) | `ON_PARAM` |
