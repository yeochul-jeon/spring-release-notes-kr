...
### 2. Spring Data JPA `getById` 메서드 변경
...
### 4. Spring Integration TaskScheduler 공유
...
### 환경 변수 접두사 (Environment Variable Prefix)
