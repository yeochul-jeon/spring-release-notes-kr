...
### 1. 순환 참조(Circular Reference) 기본 금지
...
### 5. Kafka 3.0 멱등성(Idempotence) 기본 활성화
...
### Actuator `/info` 엔드포인트에 Java 런타임 정보
...
### record 클래스로 `@ConfigurationProperties` 지원
