...
### 2. Servlet/Filter 등록 실패 시 예외 발생
...
#### `@ImportTestcontainers` 어노테이션

컨테이너 선언을 별도 클래스로 분리하여 여러 테스트에서 재사용할 수 있습니다.

#### 개발 시 Testcontainers 실행
...
### 5. Spring Authorization Server 자동 설정
