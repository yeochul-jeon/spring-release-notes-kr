...
### 2.1 @JmsListener - 어노테이션 기반 JMS 메시지 리스너
...
### 2.2 JCache (JSR-107) 캐시 어노테이션 지원
...
### 3.2 ResponseEntity Builder API
...
### 3.4 Protocol Buffers HTTP 메시지 컨버터
...
### 3.5 @Sql / @SqlConfig - 선언적 테스트 SQL 실행
