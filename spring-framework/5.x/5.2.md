...
| 항목 | 설명 | 대안 |
|------|------|------|
| `MediaType.APPLICATION_JSON_UTF8` | JSON의 기본 인코딩이 UTF-8이므로 별도 지정 불필요 | `MediaType.APPLICATION_JSON` 사용 |
| `MediaType.APPLICATION_PROBLEM_JSON_UTF8` | 위와 동일한 이유 | `MediaType.APPLICATION_PROBLEM_JSON` 사용 |
