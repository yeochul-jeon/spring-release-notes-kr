...
### AOT(Ahead-of-Time) 컴파일 및 GraalVM 네이티브 이미지 지원
...
### HTTP Interface Client (@HttpExchange)
...
### Micrometer 기반 관찰 가능성(Observability) 통합
...
### PathPatternParser 기본 적용 및 후행 슬래시 매칭 변경
